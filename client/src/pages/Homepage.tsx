        ...
        <div className='flex flex-col justify-center items-center h-full bg-[url("./assets/background.jpg")] bg-cover select-none'>
            <div className='backdrop-blur-lg w-full h-full flex items-center flex-col justify-center'>
                <div className='flex justify-center items-center'>
                    ...
                    <h1 className='font-bold bg-linear-to-r from-red-600/0 to-red-900 text-transparent bg-clip-text blur-sm text-9xl'>relaygram</h1>
                    <h1 className='font-bold bg-linear-to-r from-blue-900 text-transparent to-blue-600/0 bg-clip-text blur-xs text-9xl absolute'>relaygram</h1>
                ...
                <div className="buttons m-10 flex flex-row gap-10 justify-center items-center pt-5">
                    ...
                    <Link to={'/about'}><Button variant="outline" className='hover:bg-white/90 text-white bg-transparent active:bg-white/80 p-6 font-semibold shadow-lg text-lg backdrop-blur-3xl cursor-pointer '>about this app</Button></Link>
                </div>
