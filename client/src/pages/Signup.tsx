        ...
        <div className='flex justify-center items-center min-h-screen w-full bg-black select-none'>
            <div className='flex flex-col gap-3 border rounded-2xl px-6 pt-8  border-white/15'>
                ...
                <div>
                    ...
                    <Input className='placeholder:text-lg text-muted min-w-xs p-3 py-7 border-white/15' id="input-pass" type="password" placeholder="Enter Password" />
                </div>
                ...
                <p className='text-muted/70 text-center text-lg p-4 mt-4 border-t border-white/15'>Already a user? <Link to={'/signin'} className='underline hover:text-white/90 transition-all active:text-white/30'>Login</Link></p>
            </div>
        </div>
    );
};
